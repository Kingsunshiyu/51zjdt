 ...
 */
		...
		$category = pdo_fetchall("SELECT * FROM " . tablename($this->table_classify) . " WHERE weid =  '{$_W['uniacid']}' AND schoolid ={$schoolid} AND type = 'theclass'", array(':weid' => $_W['uniacid'], ':schoolid' => $schoolid, ':type' => 'theclass'), 'sid');
