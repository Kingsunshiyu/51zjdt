 ...
 */
        ...
        if ($operation == 'post') {
            ...
            if (checksubmit('submit')) {
                ...
                message('修改成功！', $this->createWebUrl('cardlist', array('op' => 'display', 'schoolid' => $schoolid)), 'success');
            }
            ...
            if (!empty($_GPC['idcard'])) {
                $cid = intval($_GPC['idcard']);
                $condition .= " AND idcard = '{$idcard}'";
            }
