 ...
 */
        ...
        if ($operation == 'post') {// 点击添加食谱，编辑管理，都从这里执行
        // 编辑：http://www.daren007.com/wq/web/index.php?c=site&a=entry&op=post&schoolid=4&id=31&do=cook&m=fm_jiaoyu
        // 添加：http://www.daren007.com/wq/web/index.php?c=site&a=entry&op=post&schoolid=4&do=cook&m=fm_jiaoyu
        // 显示：http://www.daren007.com/wq/web/index.php?c=site&a=entry&op=display&schoolid=4&do=cook&m=fm_jiaoyu
        // 删除：http://www.daren007.com/wq/web/index.php?c=site&a=entry&op=delete&schoolid=4&id=31&do=cook&m=fm_jiaoyu
...
//                fucki($data);
        ...
        } elseif ($operation == 'display') {// 点击食谱列表，从这里执行
        ...
        } elseif ($operation == 'delete') {// 点击删除，从这里执行
            // 删除：http://www.daren007.com/wq/web/index.php?c=site&a=entry&op=delete&schoolid=4&id=31&do=cook&m=fm_jiaoyu
        ...
        } elseif ($operation == 'deleteall') {// 点击批量删除，从这里执行
