    ...
    function In_1() {
        ...
        setTimeout(function() {
            xiaoyu(".banner_bg1").stop().animate({ opacity: 1 }, function() {
                setTimeout(function() {
                    xiaoyu(".banner1_title").stop().animate({ "top": "196px", "left": "400px", opacity: 1 }, 1000);
                    setTimeout(function() {
                        xiaoyu(".banner1_icon").stop().animate({ "top": "450px", "left": "820px", opacity: 1 }, 1000);
                        setTimeout(function() {
                            xiaoyu(".banner1_1").stop().animate({ "top": "320px", "left": "400px", opacity: 1 }, 1000);
                            setTimeout(function() {
                                xiaoyu(".banner1_2").stop().animate({ "top": "320px", "left": "520px", opacity: 1 }, 700);
                                setTimeout(function() {
                                    xiaoyu(".banner1_3").stop().animate({ "top": "320px", "left": "640px", opacity: 1 }, 700);
                                    setTimeout(function() {
                                        xiaoyu(".banner1_4").stop().animate({ "top": "320px", "left": "760px", opacity: 1 }, 700);
                                        setTimeout(function() {
                                            xiaoyu(".banner1_5").stop().animate({ "top": "320px", "left": "880px", opacity: 1 }, 700,
                                                function() {
                                                    lose = 0;
                                                });
                                        }, 0);
                                        setTimeout(function() {
                                            xiaoyu(".banner1_icon").stop().animate({ "bottom": "60px", "right": "488px", opacity: 1 }, 700, function() {
                                                lose = 0;
                                            });
                                        }, 250);
                                    }, 0);
...
function Out_1() {
    setTimeout(function() {
        xiaoyu(".banner1_title").stop().animate({ "top": "220px", "left": "750px", opacity: 0 }, 1000);
        setTimeout(function() {
            xiaoyu(".banner1_1").stop().animate({ "top": "180px", "left": "468px", opacity: 0 }, 700);
            xiaoyu(".banner1_2").stop().animate({ "top": "210px", "left": "468px", opacity: 0 }, 700);
            xiaoyu(".banner1_3").stop().animate({ "top": "240px", "left": "468px", opacity: 0 }, 700);
            xiaoyu(".banner1_4").stop().animate({ "top": "270px", "left": "468px", opacity: 0 }, 700);
            xiaoyu(".banner1_5").stop().animate({ "top": "300px", "left": "468px", opacity: 0 }, 700);
            setTimeout(function() {
                xiaoyu(".banner1_icon").stop().animate({ "bottom": "0", "right": "548px", opacity: 0 }, 700);
            }, 250);
        }, 300);
    }, 0);
}
