...
<div class="panel panel-default">
    <div class="panel-heading black">
        <img class="pull-left" src="<?php echo MODULE_URL;?>icon.jpg"/>
        ...
        <div class="collapse" id="collapseExample">
            <div class="col-xs-12 col-sm-6">
                <div class="alert alert-success" role="alert" style="line-height: 30px; overflow: hidden">
                    ...
                    <img src="<?php echo MODULE_URL;?>images/ok.jpg" class="img-responsive" />
                </div>
            </div>
            <div class="col-xs-12 col-sm-6">
                <div class="alert alert-danger" role="alert" style="line-height: 30px; overflow: hidden">
                    ...
                    <img src="<?php echo MODULE_URL;?>images/err.jpg" class="img-responsive" />
                </div>
            </div>
            ...
            <div class="alert alert-info" role="alert" style="line-height: 30px; overflow: hidden">
                ...
                <p class="bg-danger">
                    　　该公众号共有<?php  echo $_rows;?>个粉丝（这里面包括已经关注的和关注后取消关注的粉丝）。<br />
                    　　当前关注的粉丝真实数量为<?php  echo $_rows2;?>个。
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6 col-md-8 col-xs-12">
                <?php  if(is_array($accounts)) { foreach($accounts as $key => $acid_list) { ?>
                <div class="radio">
                    <label>
                        <input type="radio" class="radio_acid" name="radio_acid" id="<?php  echo $key;?>" value="<?php  echo $key;?>" <?php  if($rel_acid_count < 2){ ?> checked<?php  }elseif($key == $rel_acid2['acid']){echo "checked";} ?> >
                        <?php  echo $acid_list['name'];?>
                    </label>
                    <p>key=<?php  echo $key;?>
                        $rel_acid2['acid']=<?php  echo $rel_acid2['acid'];?>
                        rid=<?php  echo $_GPC['rid'];?>
                    </p>
                </div>
                <?php  } } ?>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6 col-md-8 col-xs-12">
                <input class="form-control content" name="num" value="<?php  echo $reply['num'];?>" placeholder="范围0-9999999"/>
            </div>
        </div>
