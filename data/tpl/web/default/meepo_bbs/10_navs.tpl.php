...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('nav',array('op' =>'display'))?>">导航列表</a></li>
	<li<?php  if(empty($adv['id']) && $operation == 'post') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('nav',array('op' =>'post'))?>">添加导航</a></li>
	<?php  if(!empty($_GPC['id']) &&  $operation == 'post') { ?><li  class="active"><a href="<?php  echo $this->createWebUrl('nav',array('op' =>'post','id'=>$_GPC['id']))?>">编辑广告</a></li><?php  } ?>
</ul>
		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><img src="<?php  echo tomedia($adv['icon'])?>" style="width:80px;height:80px;border-radius:30px;"/></td>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" id='advname' name="name" class="form-control" value="<?php  echo $adv['name'];?>" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<br>
						建议尺寸大小42*32px &nbsp;&nbsp;<a href="http://www.easyicon.net/" target="_black">去挑选一个好看的图标</a>
					</div>
				</div>
				 <div class="form-group">
