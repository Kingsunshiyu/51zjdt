...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('adv',array('op' =>'display'))?>">广告列表</a></li>
	<li<?php  if(empty($adv['id']) && $operation == 'post') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('adv',array('op' =>'post'))?>">添加广告</a></li>
	<?php  if(!empty($adv['id']) &&  $operation == 'post') { ?><li  class="active"><a href="<?php  echo $this->createWebUrl('adv',array('op' =>'post','id'=>$adv['id']))?>">编辑广告</a></li><?php  } ?>
</ul>
		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><label class="label label-success"><?php  echo $adv['typetitle'];?></label></td>
