...
<ul class="nav nav-tabs">
	<li <?php  if($do == 'pay') { ?>class="active"<?php  } ?>><a href="<?php  echo url('paycenter/wxmicro/pay');?>">刷卡收款</a></li>
</ul>
...
$(function(){
	angular.module('paycenterApp').value('config', {
		...
		'card_check_url' : '<?php  echo url('paycenter/card/check')?>',
		'pay_url' : '<?php  echo url('paycenter/wxmicro/pay')?>',
		'query_url' : '<?php  echo url('paycenter/wxmicro/query')?>',
		'checkpay_url' : '<?php  echo url('paycenter/wxmicro/checkpay')?>',
		'redirect_url' : '<?php  echo url('paycenter/wxmicro')?>'
	});
