...
<head>
	...
	<title><?php  if(isset($title)) $_W['page']['title'] = $title?><?php  if(!empty($_W['page']['title'])) { ?><?php  echo $_W['page']['title'];?> - <?php  } ?><?php  if(empty($_W['page']['copyright']['sitename'])) { ?><?php  if(IMS_FAMILY != 'x') { ?>微信公众平台管理系统-功能之强，秒杀一切-012wz.com<?php  } ?><?php  } else { ?><?php  echo $_W['page']['copyright']['sitename'];?><?php  } ?></title>
		...
		<div class="headbg">
			<div class="head xiaoyu_head cl">
				...
				<div id="nav" class="nav">
					<ul>
						<li onClick="navmove('#index','0')" class="active"><a href="./">首页</a></li>
						<li onClick="navmove('#about','3')"><a href="<?php  echo url('article/news-show/list');?>">公司介绍</a></li>
						<li onClick="navmove('#index','1')"><a href="./">大教育</a></li>
						<li onClick="navmove('#index','2')"><a href="./">大健康</a></li>
						<li onClick="navmove('#index','1')"><a href="./">大旅游</a></li>
						<li onClick="navmove('#index','1')"><a href="./">大物流</a></li>
						<li onClick="navmove('#index','1')"><a href="./">大服务</a></li>
						<li onClick="navmove('#login','4')"><a href="<?php  echo url('user/login');?>" title="登陆">后台登陆</a></li>
						<!-- <li onClick="navmove('#project','1')"><a href="<?php  echo url('article/plug-show/list');?>">大教育</a></li>
						<li onClick="navmove('#services','2')"><a href="<?php  echo url('article/case-show/list');?>">大健康</a></li>
						<li onClick="navmove('#services','1')"><a href="<?php  echo url('website/wenda-show/list');?>">大旅游</a></li>
						<li onClick="navmove('#services','1')"><a href="<?php  echo url('website/taocan-show');?>">大物流</a></li>
						<li onClick="navmove('#services','1')"><a href="<?php  echo url('website/taocan-show');?>">大服务</a></li>
						<li onClick="navmove('#login','4')"><a href="<?php  echo url('user/login');?>" title="登陆">后台登陆</a></li>
