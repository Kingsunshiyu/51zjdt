														...
														<div class="slide_pic">
															<ul>
																<li>
																	...
																	<div class="banner_bg1 opacity" style="opacity: 1;">
																		<img src="./resource/weidongli/images/banner5Bg.jpg" width="1920" height="612">
																	</div>
																	<div class="banner1_1 poa opacity" style="opacity: 1; top: 196px; left: 180px;">
																		<img src="./resource/weidongli/images/banner_icon_大教育.png" width="106" height="108">
																	</div>
																	<div class="banner1_2 poa opacity" style="opacity: 1; top: 196px; left: 300px;">
																		<img src="./resource/weidongli/images/banner_icon_大健康.png" width="106" height="108">
																	</div>
																	<div class="banner1_3 poa opacity" style="opacity: 1; top: 196px; left: 420px;">
																		<img src="./resource/weidongli/images/banner_icon_大物流.png" width="106" height="108">
																	</div>
																	<div class="banner1_4 poa opacity" style="opacity: 1; top: 196px; left: 540px;">
																		<img src="./resource/weidongli/images/banner_icon_大旅游.png" width="106" height="108">
																	</div>
																	<div class="banner1_5 poa opacity" style="opacity: 1; top: 196px; left:660px;">
																		<img src="./resource/weidongli/images/banner_icon_大服务.png" width="106" height="108">
																	</div>
																	<div class="banner1_title poa opacity" style="opacity: 1; top: 320px; left:560px;">
																		<img src="./resource/weidongli/images/banner_标题.png" width="670" height="60">
																	</div>
																	<div class="banner1_icon poa opacity" style="opacity: 1; top: 550px; left:660px;">
																		<!-- <img src="./resource/weidongli/images/banner_icon_上报.png" width="210" height="54"> -->
																	</div>
																</li>
																<li>
																	<a href="javascript:void(0);" style="display: none;"></a>
																	<div class="banner_bg2 opacity" style="opacity: 0;">
																		<img src="./resource/weidongli/images/banner2Bg.jpg" width="1920" height="612">
																	</div>
																	<div class="banner2_img1 poa opacity" style="opacity: 0; bottom: -150px; left: 460px;">
																		<img src="./resource/weidongli/images/banner2_img1.png" width="414" height="431">
																	</div>
																	<div class="banner2_img2 poa opacity" style="opacity: 0; top: 80px; left: 625px;">
																		<img src="./resource/weidongli/images/banner2_img2.png" width="203" height="424">
																	</div>
																	<div class="banner2_title poa opacity" style="opacity: 0; top: 210px; left: 1238px;">
																		6亿人都在用手机浏览网页，
																		<br>为您的准备了什么？
																	</div>
																	<div class="banner2_text banner2_text1 poa opacity" style="opacity: 0; top: 340px; left: 1238px;">
																		<p class="p1"><i class="icon1 icon"></i>200多种高级功能，秒杀市场其他平台系统</p>
																		<p class="p2"><i class="icon2 icon"></i>更多功能升级中，让世界为您的产品点赞</p>
																	</div>
																	<div class="banner2_text banner2_text2 poa opacity" style="opacity: 0; top: 410px; left: 1238px;">
																		<p class="p1"><i class="icon3 icon"></i>全球分红商城:店中店/核中核/O2O分销，电商终结者</p>
																		<p class="p2"><i class="icon4 icon"></i>大数据分销:分销终结者，秒杀市场其他分销系统</p>
																	</div>
																	<div class="banner2_text banner2_text3 poa opacity" style="opacity: 0; top: 470px; left: 1238px;">
																		<p class="p1"><i class="icon5 icon"></i>智慧投票:投票系统终结者，内置图片/视频/语音投票</p>
																		<p class="p2"><i class="icon6 icon"></i>智慧小区:实现智慧+生活，内置超市系统</p>
																	</div>
																</li>
																<li>
																	<a href="http://wx.51zjdt.com/web/index.php?c=account&a=welcome&#" style="display: none;"></a>
																	<div class="banner_bg3 opacity" style="opacity: 0;">
																		<img src="./resource/weidongli/images/banner3Bg.jpg" width="1920" height="612">
																	</div>
																	<div class="banner3_img poa opacity" style="opacity: 0; bottom: -50px; left: 500px;">
																		<img src="./resource/weidongli/images/banner3_img.png" width="683" height="466">
																	</div>
																	<div class="banner3_text g opacity" style="opacity: 0; top: 215px; right: 468px;">
																		<img src="./resource/weidongli/images/banner3_text.png" width="238" height="199" border="0">
																	</div>
																	<div class="banner3_btn poa opacity" style="opacity: 0; bottom: 0px; right: 548px;">
																		<img src="./resource/weidongli/images/banner3_btn.png" width="203" height="68">
																	</div>
																</li>
																<li>
																	<a href="javascript:void(0);" style="display: none;"></a>
																	<div class="banner_bg4 opacity" style="opacity: 0;">
																		<img src="./resource/weidongli/images/banner4Bg.jpg" width="1920" height="612">
																	</div>
																	<div class="banner4_img poa opacity" style="opacity: 0; top: 132px; left: 498px;">
																		<img src="./resource/weidongli/images/banner4_img.png" width="319" height="446">
																	</div>
																	<div class="banner4_title1 poa opacity" style="opacity: 0; top: 255px; left: 960px;"><img src="./resource/weidongli/images/banner4_title1.png" width="101" height="47"></div>
																	<div class="banner4_title2 poa opacity" style="opacity: 0; top: 255px; left: 1118px;"><img src="./resource/weidongli/images/banner4_title2.png" width="101" height="47"></div>
																	<div class="banner4_title3 poa opacity" style="opacity: 0; top: 255px; left: 1280px;"><img src="./resource/weidongli/images/banner4_title3.png" width="101" height="48"></div>
																	<div class="banner4_text poa opacity" style="opacity: 0; top: 348px; left: 960px;">
																		<p>中国匠心谷<br>
																			中国匠心谷，云端职教城<br>
																			多彩贵州风，职教中国云<br>
																			以匠人之心，育大国工匠<br>
																...
																<li>
																	<a href="http://wx.51zjdt.com/" style="display: none;"><img src="./resource/weidongli/images/pic04.jpg" width="1920" height="612" alt="新时代"></a>
																</li>
															</ul>
														</div>
														<a href="javascript:void(0);" class="slide_left" style="left: 0px;"><img src="./resource/weidongli/images/focus_btnleft.png" width="50" height="124" class="png"></a>
														<a href="javascript:void(0);" class="slide_right" style="right: 0px;"><img src="./resource/weidongli/images/focus_btnright.png" width="50" height="124" class="png"></a>
													</div>
												</div>
											</div>
										</div>
						...
						<ul id="services_ul" class="mouseslider">
							<li>
								<a href="javascript:void(0);" onclick = "services_tab('0','true');">
									...
									<h3>大教育 <span>BIG EDUCATION</span></h3>
									<!-- <p>品牌进行时…</p> -->
								</a>
							</li>
