...
<div class="panel panel-info">
     <div class="panel-heading">类型设置</div>
...
<div class="panel panel-info">
     <div class="panel-heading"><a class="btn btn-primary" href="<?php  echo $this->createWebUrl('type', array('op' => 'display'))?>"><i class="fa fa-tasks"></i> 返回类型列表</a></div>
</div>	
<div class="main">
