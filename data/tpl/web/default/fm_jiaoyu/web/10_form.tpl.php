    ...
    <div class="panel-body">
                    ...
                    <div class="alert">
                        <div style="position:relative">
                            <div class="reply-news-list-cover">
                                <img src="<?php  echo $showpicurl;?>"/>
                            </div>
                            <div class="reply-news-list-detail">
                                <span class="help-block title"><strong><?php  echo $activity['title'];?></strong></span>
                                <span class="help-block content"><?php  echo cutstr(strip_tags($activity['info']), 50)?></span>
                            </div>
                            <div class="clear"></div>
                        </div>
                    </div>
        ...
        <div class="col-sm-12">
            <div class="alert" style="text-align:center;">
                <a href="javascript:;" class="btn btn-default" onclick="$('#modal-module-menus').modal();"><i class="fa fa-plus"></i> 选择要展示的分校</a>
            </div>
        </div>
    </div>
</div>
<div id="modal-module-menus"  class="modal fade" tabindex="-1">
    <div class="modal-dialog" style='width: 920px;'>
        <div class="modal-content">
             <div class="modal-header"><button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button><h3>选择要展示的分校</h3></div>
