...
<div class="panel panel-info">
	...
	<div class="panel-body">
            <div class="form-group">
                <a class="btn btn-primary btn-sm" href="<?php  echo $this->createWebUrl('article', array('op' => 'post', 'schoolid' => $schoolid))?>">添加文章</a>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right; position:relative;">
						<a href="<?php  echo $this->createWebUrl('article', array('op' => 'post', 'id' => $item['id'], 'schoolid' => $schoolid))?>" title="编辑">编辑</a>&nbsp;-&nbsp;
						<a onclick="return confirm('此操作不可恢复，确认吗？'); return false;" href="<?php  echo $this->createWebUrl('article', array('op' => 'delete', 'id' => $item['id'], 'schoolid' => $schoolid))?>" title="删除">删除</a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
