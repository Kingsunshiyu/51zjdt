        ...
        <div class="table-responsive panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th style="width:13%;">讲师名称</th>
					<th style="width:12%;">讲师QQ</th>
					<th style="width:12%;">讲师微信</th>
					<th style="width:12%;">讲师类型</th>
                ...
                <tbody>
                    ...
                    <tr>
						...
						<td><?php  if($teacher['status']==-1) { ?><span class="label label-default">未通过</span><?php  } else if($teacher['status']==1) { ?><span class="label label-success">审核通过</span><?php  } else if($teacher['status']==2) { ?><span class="label label-danger">待审核</span><?php  } ?></td>
            ...
            <div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
						...
						<span class="help-block">添加QQ群加群连接后，前台点击“咨询—QQ群”后将自动添加群。<a href="http://help.012wz.com/index.php?doc-view-22" target="_blank">如何获取QQ群加群链接?</a></span>
                    </div>
                </div>
				<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea style="height:75px;" class="form-control richtext" name="teacherdes"><?php  echo $teacher['teacherdes'];?></textarea>
                    </div>
                </div>
				<div class="form-group">
