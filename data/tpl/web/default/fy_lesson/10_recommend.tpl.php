        ...
        <form id="myform" name="myform" method="post" class="form-horizontal form" >
			<div class="table-responsive panel-body">
				<table class="table table-hover">
					<thead class="navbar-inner">
					<tr>
						<th style="text-align:center;width:40px;">全选<br/><input type="checkbox" id="btnSelect" class="btn btn-default" onclick="checkAll(myform.hidnSelectFlag.value);" /></th>
						<th style="width:25%;padding-left:30px;">课程名称</th>
						<th style="width:10%;">课程价格</th>
						<th style="width:10%;">课程状态</th>
						<th style="width:10%;">推荐板块</th>
