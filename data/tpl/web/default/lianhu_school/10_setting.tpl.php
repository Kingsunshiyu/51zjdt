...
<div class="main">
	<form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">系统版本</label>
					<div class="col-sm-9 col-xs-12">
						<input type='radio' value='6' name='version' <?php  if($settings['version']==6) { ?> checked <?php  } ?>> 系统0.6版&nbsp;&nbsp;
						<input type='radio' value='7' name='version' <?php  if($settings['version']==7) { ?> checked <?php  } ?>> 系统0.7版
					</div>
				</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">是否开启熊孩子（开发中）</label>
					<div class="col-sm-9 col-xs-12">
						<input type='radio' value='0' name='mylovekid' <?php  if($settings['mylovekid']==0) { ?> checked <?php  } ?>> 不开启&nbsp;&nbsp;
						<input type='radio' value='1' name='mylovekid' <?php  if($settings['mylovekid']==1) { ?> checked <?php  } ?>> 开启
					</div>
				</div>
				<div class="form-group">
    ...
    <div class="panel panel-default">
                <div class="panel-heading">七牛云（非多校）(用于及时沟通处理沟通中可能出现的图片和语音，暂时不处理其他业务)</div>
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否开启七牛</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type='radio' value='0' name='qiniu' <?php  if($settings['qiniu']==0) { ?> checked <?php  } ?>> 不开启&nbsp;&nbsp;
                            <input type='radio' value='1' name='qiniu' <?php  if($settings['qiniu']==1) { ?> checked <?php  } ?>> 开启
                        </div>
                    </div>
    ...
    <div class="panel panel-default">
                <div class="panel-heading">智慧学校云配置（非多校）</div>
                    <div class="form-group">
