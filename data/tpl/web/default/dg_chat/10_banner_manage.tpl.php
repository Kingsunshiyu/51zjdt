...
<ul class="nav nav-tabs">
	<li <?php  if($_GPC['do'] =='' ||$_GPC['do'] == 'banner_manage' && $_GPC['op'] <> 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('banner_manage', array('rid' => $rid))?>">幻灯片</a></li>
	<li <?php  if($_GPC['op'] == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('banner_manage', array('rid' => $rid, 'op' => 'post' ))?>">添加幻灯片</a></li>
</ul>
