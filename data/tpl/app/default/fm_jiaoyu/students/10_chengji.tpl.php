...
<html lang="zh-cn">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo OSSURL;?>public/mobile/css/reset.css?<?php  echo time()?>">
        <script src="<?php echo OSSURL;?>public/mobile/js/jquery.js?<?php  echo time()?>"></script>
</head>
<body>
...
//     window.location.href = "<?php  echo $this->createMobileUrl('chaxun', array('schoolid' => $schoolid, 's_name' => s_name, 'mobile' => mobile), true)?>";
