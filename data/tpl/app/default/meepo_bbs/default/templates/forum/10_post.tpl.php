		...
		<div class="pub-con">
			<div class="pub-wrap section-1px  show">
				...
				<div class="editor-outer">
					<textarea id="contentText" spellcheck="false" name="content" class="editor" placeholder="内容，10-700个字"><?php  echo $setting['content'];?></textarea>
				</div>
				<div class="pub-location text-overflow-ellipsis">
                   ...
                   <?php  if(is_array($cats)) { foreach($cats as $cat) { ?>
            		<option value="<?php  echo $cat['typeid'];?>" <?php  if($cat['typeid']==$setting['fid']) { ?>selected<?php  } ?> <?php  if(!empty($cat['ch'])) { ?>style="color:rgb(39, 145, 220)" disabled<?php  } ?>>|<?php  echo $cat['name'];?></option>
            	...
            	<?php  if(is_array($cats)) { foreach($cats as $cat) { ?>
            	<li class="up-pic">
            		<input type="radio" name="fid" value="<?php  echo $cat['typeid'];?>">
            		<img id="selectCat<?php  echo $cat['typeid'];?>" class="<?php  if($cat['typeid']==$setting['fid']) { ?>selected<?php  } ?>" src="<?php  echo tomedia($cat['icon'])?>" alt="<?php  echo $cat['name'];?>"/>
            	</li>
            	<?php  } } ?>
