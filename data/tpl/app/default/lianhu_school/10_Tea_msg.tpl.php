         ...
         <?php  if($model=='student') { ?>
            <ul class='student_line'>
                    <?php  if(is_array($result)) { foreach($result as $item) { ?>
                            <li><?php  echo $this->result_result($item,$model,'name','tea_msg');?>&nbsp;
                               <input type='checkbox' value='<?php  echo $item['student_id'];?>' name='have[]' style='width:15px;'> 
                            </li>
                    <?php  } } ?>
                </ul>
           <?php  } ?>        
			...
			<tbody>
				...
				<tr>
					<td><?php  if($model!='student') { ?>
						...
						<?php  echo $this->result_result($item,$model,'name','tea_msg');?>
