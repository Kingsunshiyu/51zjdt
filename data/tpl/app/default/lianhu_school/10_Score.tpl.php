...
<!-- <div class="top-wrap">
    ...
    <?php  if($ac=='listall') { ?>
     <div class="panel member-nav" style="margin-bottom:60px;">
                &nbsp;&nbsp;<i class="fa fa-bar-chart" style='color:#ff0033'></i>&nbsp;&nbsp;<span class="text">总分：<span class='red'><?php  echo $all_score;?></span></span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="text">排名：<span class='red'><?php  echo $sort;?></span></span>
