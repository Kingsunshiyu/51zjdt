...
<link rel="stylesheet" href="<?php echo TEMPLATE_PATH;?>/wtCommon.css?v=100">
<style type="text/css">
  .video-discuss-face {
    background: url(<?php echo TEMPLATE_PATH;?>/img/face.png) no-repeat;
...
<script type="text/javascript" src="<?php echo TEMPLATE_PATH;?>/js/chat_main.js?v=20161109"></script>
...
<link rel="stylesheet" href="<?php echo TEMPLATE_PATH;?>/thousandLive.css?v=20151024">
...
<div class="slideT" style="display: none;">
	<div class="swiper-container swiper-container-horizontal">
		...
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide" attr-id="<?php  echo $ppt['id'];?>" attr-index="<?php  echo $index;?>">
				<img src="<?php  echo $ppt['img_url'];?>" width="100%">
			</div>
			<?php  } } ?>
		</div>
...
<div class="speakBox <?php  if(($is_guest||$is_manager)&&$istopic_end==0 ) { ?>hasTabBottom<?php  } ?><?php  if(!($is_guest||$is_manager)) { ?>hasUserTabBottom<?php  } ?>">
	...
	<div class="liveHeader">
		<a class="guest_head" href="<?php  echo $guest_manager_url;?>">
		<i><img src="<?php  echo $chat_room['create_avatar'];?>"></i>
		<?php  if(is_array($guests)) { foreach($guests as $guest) { ?>
				<i><img src="<?php  echo $guest['guest_avatar'];?>"></i>
		<?php  } } ?>		
			<b></b>
		</a>
	</div>
	...
	<div class="speakContentBox">
		...
		<div class="scrollContentBox" id="scrollContentBox">
			...
			<div class="guide_tips_box setGuestTips" style="display: block;">
				...
				<div class="gtbbtn"><a href="<?php  echo $invite_url;?>">立即邀请</a></div>
			</div>
			<?php  } ?>
	...
	<div id="speakBottom" class="speakBottom">
		...
		<div class="text_input_box">
			...
			<i class="btnLiveTalk" id="btn_send" onmousedown="return false">发送</i>
...
<div class="geneBox commentReplyBox">
	<div class="main">
	<div class="gene_content">
		<textarea class="reply_textarea" placeholder="点击发送后，回复内容会同步到直播主屏" onkeyup=" if($(this).val().length &gt;= 2000) $(this).val($(this).val().substr(0,2000))"></textarea>
	</div>
	<div class="gene_bottom both">
		<span><a href="javascript:;" class="gene_btn gene_cancel">取消</a></span>
		<span><a href="javascript:;" class="gene_btn gene_confirm">确定</a></span>
...
<div class="danmu_bar on">
	<div class="main">
		...
		<?php  if($is_manager || $is_guest) { ?>
		  <span class="allcount">当前人气<i></i><var class="qlOLPeople"><?php  echo $topic['look_numbers'];?></var></span>
		<?php  } else { ?>
		  <span class="allcount">当前人气<i></i><var class="qlOLPeople"><?php  echo $topic['look_numbers'];?></var></span>
		<?php  } ?>
...
<div class="control_box">
	...
	<div class="cbox_main">
		...
		<dl>
			...
			<dd class="dd_1"><a href="<?php  echo $invite_url;?>">邀请嘉宾</a></dd>
			<?php  } ?>
			<dd class="dd_2"><span id="allShutup" class="btn_switch <?php  if($topic['is_allshutup']==1) { ?> swon <?php  } ?>"></span><b>讨论区禁言模式</b></dd>
		
				<dd class="finish_live_box">
				<?php  if($istopic_end==0) { ?>
					<span>结束直播</span>
					<a class="btn_finish_live" attr-topicid='<?php  echo $topic_id;?>' href="javascript:;">结束本次直播</a>
				<?php  } else { ?>
				    <span>该直播已结束</span>
				<?php  } ?>
...
<div class="pptBox" style="display: none;">
	...
	<div class="pptList">
		...
		<div class="pptItem" ppt-id="<?php  echo $ppt['id'];?>" ppt-order="<?php  echo $ppt['img_order'];?>">
			<div class="leftBox">
				<div class="imgBox"><img src="<?php  echo $ppt['img_url'];?>"></div>
				<div class="state"><?php  if($ppt['is_current']==1) { ?>当前<?php  } ?></div>
				<div class="cancel"><?php  if($ppt['is_send']==1) { ?>撤回<?php  } ?></div>
			</div>
			<div class="up"></div>
			<div class="down"></div>
