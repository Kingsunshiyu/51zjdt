...
<meta name="apple-mobile-web-app-title" content="考试"/>
...
/*header{ background:url(<?php  echo $this->_img_url?>btn_header_right_normal.png) repeat-x;  line-height:50px; height:50px; text-align:center; width:100%;}*/
/*header h1{ color:#fff; height:50px; font: 600 1.286em/2.8 "Microsoft Yahei"; }*/
...
/*header .xuan{ position:absolute; width:110px;padding-top:20px; height:30px; right:0px; top:0px; color:#FFF;font: 500 14px/1 "Microsoft Yahei";border-left:#7bb1f9 1px solid;}*/
...
.tagContent button{ background:url(<?php  echo $this->_img_url?>btn_login_normal.png) no-repeat; background-size:100% 80%; width:90%; height:50px; border: 0 none;margin:20px 20px 0px 20px;color:#FFF;font: 400 16px/2.8 "Microsoft Yahei"; }
...
#tagContent1 table .first{ background:url(<?php  echo $this->_img_url?>bg_paper_ranking_light.png) no-repeat scroll 5px 7px rgba(0, 0, 0, 0); width:55px; height:60px; color:#FFF;}
	...
	<div id="tagContent">
		<div id="tagContent1" class="tagContent selectTag">
			<table width="100%" border="0">
				...
				<tr id="no_list" style="display: none;">
					<td colspan="6"><br>还没有排行榜数据</td>
				</tr>
				<tr id="d_page" style="display: none;">
					<td id="d_more" colspan="6" style="padding-top: 15px;padding-bottom: 15px;">点击加载更多排行榜</td>
				</tr>
			</table>
				<!--<div class="more" id="d_page" style="display: none;">-->
				<!--<a style="" class="ui-link" href="javascript:;" id="d_more">点击加载更多排行榜</a>-->
				<!--</div>-->
			</div>
		</div>
    </div>
...
<script type=text/javascript>
    $(function(){
        ...
        function get_list(page) {
            //show_loading();
            $.post("<?php  echo $this->createMobileUrl('sortlist')?>",{ac:'getDate',page:page},function(data){
                //alert(data);return false;
                //hide_loading();
                data  =eval("(" + data +")");
                if(data.result == 1){
                    //$("#d_list").after(data.code);
                    $("#no_list").before(data.code);
