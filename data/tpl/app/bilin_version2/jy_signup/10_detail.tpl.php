...
<link rel="stylesheet" href="../addons/jy_signup/css/swiper.min.css">
<link rel="stylesheet" type="text/css" href="../addons/jy_signup/css/header.css">
<link rel="stylesheet" type="text/css" href="../addons/jy_signup/css/second.css">
...
<body>
	...
	<div class="swiper-container">
      ...
      <?php  } } ?>
       ...
       <h3><?php  echo $hd['hdname'];?></h3>
	</div>

   <div class="bodybox"><div class="basic-box">
		<div class="buy-box">
			<div class="price"><span class="rmb-num"><?php  if($hd['price']>0) { ?><?php  echo $hd['price'];?> 元<?php  } else { ?>免费<?php  } ?></span></div>
      ...
      <?php  if($hd['enabled']==1) { ?>
        ...
        <?php  } else { ?>
        <?php  if($cj==1) { ?>
        <a href="<?php  echo $this->createMobileUrl('signup',array('id'=>$id))?>" class="buy-btn">修改报名</a>
        <?php  } else { ?>
        <a href="<?php  echo $this->createMobileUrl('signup',array('id'=>$id))?>" class="buy-btn">我要报名</a>
        <?php  } ?>
        <?php  } ?>
      <?php  } else { ?>
        <a href="javascript:void(0)" class="buy-btn1">活动结束</a>
  ...
  <div class="content">
    <?php  if(!empty($done)) { ?>
    <div class="M_detail">
     <div class="mod_tab"><span>有<?php  echo $done_num;?>人入选</span></div>
	...
	<!-- 免费报名类活动 -->
    <div class="M_detail">
     <div class="mod_tab"><span>有<?php  echo $hd['num'];?>人报名</span></div>
     <div class="detail-item detail-more">
    ...
    <!-- 基本信息 -->
    <div class="msgDiv" style="margin-top:15px;border-bottom:1px solid #eee"><img style="width:14px;vertical-align:top;margin-top:3px" src="../addons/jy_signup/images/shop.png"><?php  echo $hd['mendianname'];?></div>
    <?php  if(!empty($hd['tel'])) { ?>
    <a class="addressXX" href="tel:<?php  echo $hd['tel'];?>"><div class="msgDiv" style="border-bottom:1px solid #eee"><img style="width:14px;vertical-align:top;margin-top:3px" src="../addons/jy_signup/images/tel.png"><?php  echo $hd['tel'];?></div></a>
    <?php  } ?>

    <div class="msgDiv" style="border-bottom:1px solid #eee"><img src="../addons/jy_signup/images/icon-time.png"><?php  echo $hd['time'];?></div>
    <a style="color:#000;line-height:22px" href="http://api.map.baidu.com/marker?location=<?php  echo $hd['lat'];?>,<?php  echo $hd['lng'];?>&title=<?php  echo $hd['address'];?>&content=<?php  echo $hd['address'];?>&output=html&src=weiba|weiweb"><div class="msgDiv" style="margin-top:1px"><img style="vertical-align:top;margin-top:3px" src="../addons/jy_signup/images/icon-address.png"><?php  echo $hd['address'];?></div></a>
     ...
     <div class="M_detail" id="M_detail">
      ...
      <?php  if(is_array($pl)) { foreach($pl as $row) { ?>
        <div class="peopleData">
          ...
          <?php  } else { ?>
            <img class="peopleData-head" src="../addons/jy_signup/images/no-50.png" />
          <?php  } ?>
          <?php  } ?>
          <div class="peopleData-leftData">
            <div class="peopleData-name"><span><?php  echo $row['nicheng'];?></span>
              ...
              <div class="peopleData-name-support" data-support="1" data-id="<?php  echo $row['id'];?>" onclick="supportFunc(this)">
                <img src="../addons/jy_signup/images/icon-agree-on.png"/><span><?php  echo $row['num'];?></span>
              </div>
              <?php  } else { ?>
              <div class="peopleData-name-support" data-support="0" data-id="<?php  echo $row['id'];?>" onclick="supportFunc(this)">
                <img src="../addons/jy_signup/images/icon-agree.png"/><span><?php  echo $row['num'];?></span>
              </div>
              <?php  } ?>
            </div>
    ...
    <div class="M_layer fix">
     <div class="layer-box2">
      ...
      <?php  if(!empty($sc)) { ?>
        <a href="javascript:void(0);" class="icon-like" style="color:red" data-liked="1"><img class="icon-like-img" src="../addons/jy_signup/images/layer-icon1-on.png"/><label id="likedFont">已喜欢</label></a>
      <?php  } else { ?>
       <a href="javascript:void(0);" class="icon-like gray1" data-liked="0"><img class="icon-like-img" src="../addons/jy_signup/images/layer-icon1.png"/><label id="likedFont">喜欢</label></a>
      <?php  } ?>
      </div>
      <div class="layer-item">
  ...
  <script src="../addons/jy_signup/js/swiper.min.js"></script>
  <script>
  ...
  var txt = parseInt($(obj).find("span").text());
    ...
    if($(obj).data("support") == "0"){
      $.post("<?php  echo $_W['siteroot'].'app/'.substr($this->createMobileUrl('detail',array('op'=>'zan','id'=>$id)),2)?>"+"&hdcommentid="+hdcommentid,function(data){
          if (data == 1) {
            $(".peopleData-name-support").eq(index).find("img").attr("src","../addons/jy_signup/images/icon-agree-on.png");
      ...
      $.post("<?php  echo $_W['siteroot'].'app/'.substr($this->createMobileUrl('detail',array('op'=>'zan','id'=>$id)),2)?>"+"&hdcommentid="+hdcommentid,function(data){
          if (data == 1) {
            $(".peopleData-name-support").eq(index).find("img").attr("src","../addons/jy_signup/images/icon-agree.png");
            $(".peopleData-name-support").eq(index).find("span").text(txt-1);
  ...
  $(".icon-like").bind("click",function(){
    if($(this).data("liked") == "0"){
      $.post("<?php  echo $_W['siteroot'].'app/'.substr($this->createMobileUrl('detail',array('op'=>'sc','id'=>$id)),2)?>",function(data){
          if (data == 1) {
            $(".icon-like-img").attr("src","../addons/jy_signup/images/layer-icon1-on.png");
      ...
      $.post("<?php  echo $_W['siteroot'].'app/'.substr($this->createMobileUrl('detail',array('op'=>'sc','id'=>$id)),2)?>",function(data){
          if (data == 1) {
            $(".icon-like-img").attr("src","../addons/jy_signup/images/layer-icon1.png");
